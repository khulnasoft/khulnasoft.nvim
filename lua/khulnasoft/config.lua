...
function M.defaults()
	return {
		manager_path = nil,
		bin_path = vim.fn.stdpath("cache") .. "/khulnasoft/bin",
		config_path = vim.fn.stdpath("cache") .. "/khulnasoft/config.json",
		language_server_download_url = "https://github.com",
		api = {
			host = "server.khulnasoft.com",
			port = "443",
			path = "/",
			portal_url = "khulnasoft.com",
		},
		enterprise_mode = nil,
		detect_proxy = nil,
		tools = {},
...
function M.installation_defaults()
	local has_installed, installed_config = pcall(require, "khulnasoft.installation_defaults")
